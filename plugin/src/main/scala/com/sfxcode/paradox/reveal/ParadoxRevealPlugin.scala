...
object ParadoxRevealPlugin extends AutoPlugin with ParadoxRevealKeys {
  ...
  object autoImport {
    type ParadoxRevealTheme =
      _root_.com.sfxcode.paradox.reveal.ParadoxRevealTheme
    val ParadoxRevealTheme =
      _root_.com.sfxcode.paradox.reveal.ParadoxRevealTheme

    val paradoxRevealTheme =
      settingKey[ParadoxRevealTheme]("Reveal theme options")
  }
  ...
  def revealParadoxGlobalSettings: Seq[Setting[_]] =
    Seq(
      paradoxRevealVersion := readProperty(
        "paradox_reveal.properties",
        "paradox.reveal.version"
      ),
      paradoxRevealOrganization := readProperty(
        "paradox_reveal.properties",
        "paradox.reveal.organization"
      ),
      ...
      paradoxTheme := Some(
        paradoxRevealOrganization.value % "paradox-reveal-theme" % paradoxRevealVersion.value
      )
    )
  ...
  def revealParadoxSettings(config: Configuration): Seq[Setting[_]] =
    inConfig(config)(
      Def.settings(
        ...
        paradoxProperties += ("reveal.theme.version" -> readProperty(
          "paradox_reveal.properties",
          "paradox.reveal.version"
        )),
